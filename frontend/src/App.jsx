...
const CAPABILITIES = [
  {
    ...
    prompt: "a UI schema inspector showing a React prototype being assembled in real time, with a component library kanban organised by category, an active schema table with section types and render status, and a build validation alert",
  },
  {
    ...
    prompt: "a chain-of-thought trace viewer for K2-Think V3 reasoning through whether MBZUAI should launch a robotics division, with a full reasoning step timeline showing confidence and type per step, a step analysis table, and a token depth bar chart",
  },
  {
    key: "tool-calling",
    icon: "🔧",
    ...
    prompt: "a tool execution console for an AI trip-booking agent, with a timeline of named function calls — search_flights, get_weather, search_hotels, build_itinerary — showing real arguments and return values, a 3-column tool queue kanban, and a call log table",
  },
  {
    key: "planning",
    icon: "📋",
    ...
    prompt: "a multi-agent orchestration console for an EV battery investment research report, with Research, Analysis, Writing, and QA agents as kanban columns with task cards flowing between them, an orchestration timeline, and a task dependency table",
  },
  {
    key: "file-generation",
    icon: "📄",
    ...
    prompt: "an AI benchmark report studio with a report configuration form and a file_export section (type: file_export) that generates a real downloadable PDF, DOCX, and PPTX of the AI Foundation Model Benchmark Report 2026 with five detailed sections of K2-Think V3 benchmark results",
  },
  {
    key: "streaming",
    icon: "⚡",
    ...
    prompt: "a K2-Think V3 streaming API monitor with an active streams table showing live prompt snippets and tokens emitted per stream, a 60-second token throughput line chart, a completed stream latency and cost table, and a request type breakdown bar chart",
  },
];
